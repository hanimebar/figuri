  ...
  return (
    <Card className="w-full max-w-md shadow-2xl shadow-black/30">
      <CardHeader className="text-center pb-4">
        ...
        <CardDescription>Sign in to your Figuri account</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input id="password" type="password" autoComplete="current-password" aria-required="true" placeholder="••••••••" {...register('password')} />
